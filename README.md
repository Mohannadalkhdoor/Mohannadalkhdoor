...
- خبرة في التأمينات الطبية والتدقيق الداخلي  
- مهتم بالصحة والتغذية والكتابة التحليلية عن القيادة والإدارة  
- تاريخ الميلاد: 8 أيلول 1987  

## الخبرات العملية (Professional Experience)
- مدير التأمينات ورئيس المناوبين الإداريين – المستشفى الأردني الفنلندي الحديث (2021–2025)  
- دائرة التأمينات والتدقيق الطبي – مستشفى ابن الهيثم (2009–2020)  
- خبرة في عدة مستشفيات خاصة في عمّان  
...
- **Medical Audit & Risk Analysis** – تدقيق طبي وتحليل المخاطر الصحية  
...
<script type="application/ld+json">
{
  ...
  "alternateName": "أبو زينه",
  "birthDate": "1987-09-08",
  "jobTitle": "مشرف رقابة داخلية | مدير تأمينات سابق",
  "worksFor": {
    "@type": "Organization",
